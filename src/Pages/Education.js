                ...
                <div className="educationblock">
                  <div className="row">
                    <div className="col-sm-4">
                      <h5 data-aos="fade-right">Год обучение 2020 - 2024</h5>
                    </div>
                    <div className="col-sm-8">
                      <div className="educationright" data-aos="fade-left">
                        <h5>Ташкентсикй Университет Информационных Технологий</h5>
                        <h6>Факультет Кибер - Безопасность</h6>
                        <h6>
